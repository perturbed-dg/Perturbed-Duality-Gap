...
class Config():
    def __init__(self):
        ...
        self.data_task = 'mnist'

        exp = 'TRAIN/{}'.format(self.data_task)
        self.data_dir  = './{}/'.format(exp) +'output/gan/mnist/'
        self.save_images_dir =  './{}/'.format(exp) +'output/gan/mnist/GeneratedPlots/'
        self.model_dir = 'ckpts/mnist'
        ...
        self.beta1 = 0.5
        self.beta2 = 0.999
        self.valid_frequency_task = 1000
        self.print_frequency_task = 1000
