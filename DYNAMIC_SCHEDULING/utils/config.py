...
def override_config(config, args):
    ...
    if args.epsilon_greedy:
            config.epsilon_greedy = args.epsilon_greedy
        
    if args.save_images_dir:
        config.save_images_dir = args.save_images_dir

    if args.max_training_step:
        config.max_training_step = args.max_training_step

    if args.lr_ctrl:
        config.lr_ctrl = args.lr_ctrl

    if args.adv:
        config.adv = args.adv

    if args.data_task:
        config.data_task = args.data_task
    ...
    if args.valid_frequency_task:
        config.valid_frequency_task = args.valid_frequency_task
